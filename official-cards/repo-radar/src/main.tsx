...
import { App } from './App'
import { RadarController } from './controller'
import './styles.css'

// Opened on its own (npm run dev, or dist/index.html in a browser) the card runs
// against the SDK's mock host with a fake GitHub — see src/preview.ts.
...
await radar.start()
if (standalone) (await import('./preview')).afterStart(radar)
